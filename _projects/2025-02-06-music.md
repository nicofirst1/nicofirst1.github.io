...
description: "AI-generated educational music — exploring how AI-driven songs can teach concepts in AI history, science, and ethics. Includes the 'Let Babylon Burn' track on AI history."
intro: "What if music could be used as a powerful tool for education?<br>In many ways, this is already happening (think of the ABC song), which has helped generations of children learn the alphabet. However, creating music takes time, effort, and skill, which makes it difficult to apply this approach to a wide range of concepts.<br><br>With the advent of AI-generated music, though, things are changing. <strong>This project explores the use of AI-driven songs as an educational tool</strong>. It combines my passion for music (mostly as a listener, though I play some drums), my interest in AI, and my dedication to education in an attempt to create something that benefits people.<br>Enjoy the music below! If you're interested in learning more about the project's purpose and potential impact, you can find my considerations further down."

albums:
  - "album1"
---

## About "Let Babylon Burn"

One song in this project, **"Let Babylon Burn"**, traces the history of AI — from early symbolic systems to deep learning — through music. Writing the lyrics turned into an exercise in studying the field's own past, and the song has since become the most-searched piece of this project. You'll find it in the album below, alongside the lyrics and a section-by-section explanation.

### How Can AI Music Be Used for Education?

I mentioned in the intro that this project can be used for educational purposes, but I’ve gotten some feedback asking: _How exactly?_ So here I am, spending a few more words on it.
...
Ever had a song stuck in your head? You listen to it again and again, absorbing more of its content. Then curiosity kicks in _What’s this song really about? What inspired it?_
