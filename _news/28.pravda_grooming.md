...
I had to find out. Fortunately, I had Common Crawl[^2] dumps lying around from our recent training runs. Time to dig in.
...
Armed with this list, I processed **29.1 billion documents** from Common Crawl, using 1,482 CPU hours to filter through the data. The domains revealed a clear evolution in tactics:
...
While widespread, the dissemination of Pravda network documents was highly targeted. A look at the languages reveals a strategy[^missing_eng]:

| Language | Percentage | Target Region |
|----------|------------|---------------|
| Ukrainian | 34.11% | Ukraine |
| Slovak | 33.57% | Slovakia |
| Portuguese | 9.37% | Brazil/Portugal |
| German | 6.80% | Germany/Austria/Switzerland |
| Czech | 5.36% | Czech Republic |
...
[^4]: Nemotron is a curated dataset where low-quality content has been filtered out using various quality metrics. It's the kind of "clean" dataset that companies might use when they want higher quality training data than raw Common Crawl provides.

The results were mixed:
- In Nemotron's low-quality partition: 2 document per million, 6,920 documents contaminated
- In Nemotron's high-quality partition: 30 document per million, 21,998 documents contaminated
...
3. **International cooperation**: The Pravda network operates across borders. The response must be similarly coordinated.
...
The Pravda network shows us that in the age of AI, controlling information means controlling not just what people read today, but how machines will understand and explain the world tomorrow.
In an era where AI increasingly mediates our access to information, data hygiene isn't just good practice. It's a matter of information security.
