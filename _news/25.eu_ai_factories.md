...
We briefly touched on AI Factories in the [first post of this series](/_news/22.eu_and_research.md). Now that we have real-world progress to discuss, let’s focus on what AI Factories actually are, what they’re supposed to achieve, and why this matters for Europe’s AI future.
...
- Programs like **Horizon Europe** have been crucial, but their average **€3 million contributions **haven’t been enough to ignite large-scale AI industry adoption ([check out my full analysis here](/_news/21.horizon-fragmentation.md)).
...
[^cover]: I covered all of these entities in my blogpost on the [Coordinated Plan for AI](/_news/22.eu_and_research.md).
