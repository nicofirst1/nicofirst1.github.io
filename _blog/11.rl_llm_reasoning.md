...
image: /assets/images/rl_reasoning_cover.jpg
date: 2025-10-15
...
So, for the rest of this post, we’ll assume RL is the steering wheel that guides reasoning forward.
...
And this back-and-forth (action, feedback, adaptation) is the foundation of RL.
...
### GES: Generate, Evaluate, Select
Let me introduce you to **GES**

![alt text](/assets/images/blog/rl_llm_reasoning/ges.png)
...
1. Evaluate: Now you assess each option. How? That depends, but let’s stick with the shopping analogy. You realize onions would make your breath stink and you have a date later, so you give that option a low score. Carrots sound better.

2. Select: You now have a few good candidates, each with a score. Time to choose.
...
Why make one big lasagna when you can make ten small ones and experiment?
...
![alt text](/assets/images/blog/rl_llm_reasoning/tree.png)
...
Algorithms like PPO [[citation](https://openai.com/index/openai-baselines-ppo/)] and GRPO [[citation](https://medium.com/data-science-in-your-pocket/what-is-grpo-the-rl-algorithm-used-to-train-deepseek-12acc19798d3)] belong here.
...
![alt text](/assets/images/blog/rl_llm_reasoning/confused.gif)
Don’t be!
...
## From PPO to GRPO: The Two Flavors of Feedback
Now that we understand outcome supervision, it’s time to look at the two most famous acronyms in this space: PPO and GRPO.

### PPO
Let’s zoom in on what “learning from outcomes” actually looks like in practice.
The most common recipe comes with three intimidating letters: *PPO*.
...
We still need to evaluate each step and decide which actions to reinforce.
That’s where the next concept comes in: **advantage**.
...
You’re experimenting with oven temperatures: 100 °C, 150 °C, and 500 °C.
...
---
![alt text](/assets/images/blog/rl_llm_reasoning/advantage.png)
...
You’re not just memorizing oven settings anymore, you’re learning *how to learn* what makes a good lasagna.
...
Well, up until here, we've been mentining the "imagine multiple possible fucture actions" as a thing, but PPO only goes for one. That's what GRPO does differently.
...
Sounds familiar?
It should.
It’s just like our “I am all chefs at once” example, where you cooked ten mini lasagnas and kept the best one.
...
![alt text](/assets/images/blog/rl_llm_reasoning/elephant_room.png)
...
![alt text](/assets/images/blog/rl_llm_reasoning/candle.gif)
...
#### What We Can Infer
Two lessons here.
First, when we teach a model to reason in token space (basically writing its thoughts step by step) we risk ending up with a system that’s j**ust summarizing what it already knows** instead of truly reasoning.
...
Here’s the interesting part: **spatial recurrence is diffusion.**
...
![alt text](/assets/images/blog/rl_llm_reasoning/uncanny_roomo.png)
...
* [From PPO to GRPO](#from-ppo-to-grpo-the-two-flavors-of-feedback) — Two ways to learn from mistakes
