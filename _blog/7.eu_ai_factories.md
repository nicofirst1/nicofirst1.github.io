...
date: 2024-12-17
description: "Seven EuroHPC supercomputers, three funding tracks, up to 50% EU cost coverage — how Europe's AI Factories initiative actually works, and where the coordination risk sits."
untracked-views: 354
---
...
We briefly touched on AI Factories in the [first post of this series](/blog/eu-and-research/). Now that we have real-world progress to discuss, let’s focus on what AI Factories actually are, what they’re supposed to achieve, and why this matters for Europe’s AI future.
...
- Programs like **Horizon Europe** have been crucial, but their average **€3 million contributions **haven’t been enough to ignite large-scale AI industry adoption ([check out my full analysis here](/blog/horizon-analysis/)).
