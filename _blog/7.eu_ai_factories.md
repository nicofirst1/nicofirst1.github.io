---
slug: ai-factories
title: "AI Factories: Europe's €1.5B EuroHPC Supercomputer Plan"
image: /assets/images/blog/eu_landscape/eu_landscape_p4.png
date: 2024-12-17
description: "A guide to EuroHPC AI Factories: compute tracks, access and how they work"
untracked-views: 354
---
...
Europe's AI Factories are EuroHPC-backed supercomputing hubs for startups, SMEs, researchers, and public-sector users. The first seven were announced in December 2024 with EUR 1.5 billion in investment. The question is whether that infrastructure becomes a service layer people can use, or another coordination problem.
...
. Programs like **Horizon Europe** have been crucial, but their average **€3 million contributions **haven't been enough to ignite large-scale AI industry adoption ([read the Horizon Europe funding analysis](/blog/horizon-analysis/)).
...
- **Finland**: _LUMI AI Factory_ in Kajaani.
- **Germany**: _HammerHAI_ in Stuttgart.
- **Greece**: _Pharos_ in Athens.
- **Italy**: _IT4LIA_ in Bologna.
- **Luxembourg**: _L-AI Factory_ in Bissen.
- **Spain**: _BSC AI Factory_ in Barcellona.
- **Sweden**: _MIMER_ in Linkǒping.
...
At first, I’ll admit, I had a completely different idea of what an AI Factory would look like. I imagined something more project-oriented – like a company such as OpenAI or Anthropic – spitting out generative AI models that are bigger, shinier, and fancier than anyone else’s[^eval_rant]. Turns out, I was wrong.
...
[^cover]: I covered all of these entities in my blogpost on the [Coordinated Plan for AI](/blog/eu-and-research/).
...
He then introduces you to a colleague from the local **AI Factory**, who assures you they have everything you need: **HPC resources, AI expertise**, and access to **consortium partnerships**. You nod politely, still skeptical, until the magic words hit: “_AI-reduced culinary portions_”. Your eyes light up.
...
Fast forward to a sunny spring morning. You find yourself at the gates of the **AI Factory campus**. It’s bustling with activity – developers in hoodies, researchers in lab coats, and businesspeople who look like they just stepped off a plane. You think to yourself: _this is where the future happens_.
...
[^ending]: Fast forward 30 years: you’re standing on stage, holding the prestigious [EY Entrepreneur of the Year award](https://en.wikipedia.org/wiki/Ernst_%26_Young_Entrepreneur_of_the_Year_Award). The crowd cheers. Journalists swarm around you to get a glimpse of your groundbreaking achievement: the **plankton-sized pizza**. On the **[cover of Time magazine](/assets/images/news/plankton_pizza.png)**, a dish so small it requires a magnifying glass to see. The caption reads: _“Smaller than a Atom: The Plankton Pizza Revolution”_

## Can AI Factories scale over time?

AI Factories are designed to scale through their three-track system (appoint existing systems, upgrade current infrastructure, build new supercomputers). The constraint is not hardware availability but whether the coordination layer can keep pace with demand without itself becoming the bottleneck. The Lil'Bits story above hints at the real challenge: connecting a local business through EDIHs, EDICs, data spaces, and TEFs into a coherent factory experience requires that every layer exists and works. A seventh factory adds capacity; a seventh coordination gap adds fragmentation.

#### **Overview and Takeaways**

Hopefully, the _Lil’Bits_ story was entertaining (and absurd) enough to keep you reading, but more importantly, it illustrated a key point: an **AI Factory thrives on connections**.
...
2. **A Centralized Coordination Entity (CERN4AI)**:  
   Alternatively, I remain a firm believer in creating a **superseding entity** – call it _CERN for AI_, if you like. The AI Office is currently the closest thing to this idea, but it’s stretched thin with responsibilities like developing standards and aligning with the AI Act.
